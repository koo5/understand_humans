...
*/
    ...
    function graph( thanks rdfq top graph
    Returns function q.

    S p o g,
    G-super is-supergraph-of g default,
    => S p o G-super.

    g is-supergraph-of g default.

    G-super is-supergraph-of g default <=
        G-super contains x default,
        x is-supergraph-of g default.


    Class Rdfq-supergraph is a view onto the store, that filters quads by their inclusion in a given graph.

    class Rdfq_supergraph
    {
    ...
    function view_type('ldit:alert', uri)
    {
        q(uri, 'a', ldit:alert, g).map((g)=>
